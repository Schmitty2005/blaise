...
[cols="1,2", options="none"]
|===
| Self-hosting
| Yes — Blaise compiles itself with byte-for-byte identical output across bootstrap stages.

| Test coverage
| 1200+ tests and growing; Test-Driven Development from day one.

| Backend
| QBE (production); LLVM backend in active development.
|===
