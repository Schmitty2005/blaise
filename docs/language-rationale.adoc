...
Passing an array literal (`['a', 'b', 'c']`) at a call site is deferred
to a later implementation item. The current feature covers declaration,
element access, `High`/`Low`, and open-array-to-open-array forwarding.
